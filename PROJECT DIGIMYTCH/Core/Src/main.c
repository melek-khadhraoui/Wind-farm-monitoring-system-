...
#include "bmp280.h"
#include "stdio.h"
#include <string.h>  // Ajouter cette ligne
...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define DEBOUNCE_DELAY 50 // 50 ms pour le debounce(pour la vibration)
#define PULSES_PER_REVOLUTION 20 // KY-040 a 20 pas par tour(type d'encodeur)
/* USER CODE END PD */
